                ...
                <div id="registration">
                    ...
                    <form id="register" method="post" action="<?php echo base_url(); ?>register">
                        <div>
                            ...
                            <input type="text" name="customer_first_name" id="customer_first_name" value="<?php echo (isset($_POST['customer_first_name'])) ? $_POST['customer_first_name'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_middle_name"<?php echo (isset($errors['middle_name'])) ? " class='error'" : ""; ?>>Middle Name: </label>
                            <input type="text" name="customer_middle_name" id="customer_middle_name" value="<?php echo (isset($_POST['customer_middle_name'])) ? $_POST['customer_middle_name'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_last_name"<?php echo (isset($errors['last_name'])) ? " class='error'" : ""; ?>>Last Name: </label>
                            <input type="text" name="customer_last_name" id="customer_last_name" value="<?php echo (isset($_POST['customer_first_name'])) ? $_POST['customer_last_name'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_phone"<?php echo (isset($errors['customer_phone'])) ? " class='error'" : ""; ?>>Phone Number: </label>
                            <input type="text" name="customer_phone" id="customer_phone" value="<?php echo (isset($_POST['customer_phone'])) ? $_POST['customer_phone'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_email"<?php echo (isset($errors['customer_email'])) ? " class='error'" : ""; ?>>Email Address: </label>
                            <input type="text" name="customer_email" id="customer_email" value="<?php echo (isset($_POST['customer_email'])) ? $_POST['customer_email'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_street_1"<?php echo (isset($errors['street_1'])) ? " class='error'" : ""; ?>>Street: </label>
                            <input type="text" name="customer_street_1" id="customer_street_1" value="<?php echo (isset($_POST['customer_street_1'])) ? $_POST['customer_street_1'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_street_2"<?php echo (isset($errors['street_2'])) ? " class='error'" : ""; ?>>Street 2: </label>
                            <input type="text" name="customer_street_2" id="customer_street_2" value="<?php echo (isset($_POST['customer_street_2'])) ? $_POST['customer_street_2'] : ''; ?>" />
                        </div>

                        <div>
                            <label for="customer_city"<?php echo (isset($errors['city'])) ? " class='error'" : ""; ?>>City: </label>
                            <input type="text" name="customer_city" id="customer_city" value="<?php echo (isset($_POST['customer_city'])) ? $_POST['customer_city'] : ''; ?>" />
                        </div>
                        ...
                        <div>
                            ...
                            <select name="customer_state" id="customer_state">
                                ...
                                foreach($state as $key => $value) {
                                    echo "<option value='" . $key . "' " . ((isset($_POST['customer_state']) && $key == $_POST['customer_state']) ? 'selected="selected"' : '') . ">" . $value . "</option>";
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="customer_zip" id="customer_zip" value="<?php echo (isset($_POST['customer_zip'])) ? $_POST['customer_zip'] : ''; ?>" />
                        </div>
